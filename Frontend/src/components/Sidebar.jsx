...
const Sidebar = ({ 
  ...
  onStartSecretChat, // New prop for Incognito Chat
  showSecretChatButton = false // New prop to control visibility
}) => {
  ...
  const asideContent = (
    <aside 
      ...
      <div className="sidebar-footer">
        ...
        {/* Incognito Chat Button - Only show on mobile when needed */}
        {showSecretChatButton && (
          <button 
            className="secret-chat-sidebar-btn" 
            onClick={() => onStartSecretChat && onStartSecretChat()}
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12 11v1M12 7h.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            </svg>
            Incognito Chat
          </button>
        )}
